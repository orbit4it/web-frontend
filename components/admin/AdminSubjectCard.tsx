'use client';
import { CompetitionSubject } from '@/helper/interfaces';
...
interface CompetitionSubjects {
  recentSubjects: CompetitionSubject[];
}

const SubjectCard: React.FC<CompetitionSubjects> = ({ recentSubjects }) => {
  return (
    <Swiper
      spaceBetween={30}
      centeredSlides={true}
