      ...
      <Link href={'/admin/dashboard/user/anggota'}>
        <div
          className={` ${
            ...
            pathname == '/admin/dashboard/user/anggota/detail'
              ? ' bg-[#394699]'
              : 'bg-[#3C405B] hover:bg-[#394699]'
          }  text-white font-semibold text-lg lg:text-xl p-4 rounded-lg w-auto lg:w-72 cursor-pointer`}
        >
          <h1>Anggota</h1>
        </div>
      </Link>
        ...
        <div
          className={`${
            pathname == '/admin/dashboard/user/calon'
              ? ' bg-[#394699]'
              : 'bg-[#3C405B] hover:bg-[#394699]'
          }  text-white font-semibold text-lg lg:text-xl p-4 rounded-lg w-auto lg:w-72 cursor-pointer my-3`}
        >
          <h1>Calon Anggota</h1>
        </div>
      </Link>
        ...
        <div
          className={`${
            pathname == '/admin/dashboard/user/tambah'
              ? ' bg-[#394699]'
              : 'bg-[#3C405B] hover:bg-[#394699]'
          }  text-white font-semibold text-lg lg:text-xl p-[10px] rounded-lg w-auto lg:w-72 cursor-pointer`}
        >
