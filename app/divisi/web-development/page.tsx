  ...
  return (
    <>
      <header className="w-max md:flex items-center mx-auto pt-0 md:mx-0 md:gap-2 md:static">
        <div className="w-24 h-24 rounded-full relative flex items-center mx-auto -top-[40px] md:static glassmorphism-webdev before:rounded-full">
          <Image
            src={Logo}
            alt="Logo"
      ...
      <section className="w-full md:mt-14 mt-10 md:flex gap-16 px-5">
        <p className="md:w-1/2 text-base text-center md:text-left text-white leading-relaxed">
          Web Development adalah divisi yang dapat mengembangkan, membuat, dan
          memelihara sebuah website. Hal ini melibatkan perancangan tampilan,
          pengembangan kode, dan pengelolaan basis data.
        </p>
      ...
      <section className="w-full h-[38rem] lg:h-[90vh] rounded-2xl mt-10 md:mt-20 p-5 md:p-10 bg-[#0e582c] flex flex-col gap-6 items-start overflow-hidden  relative">
        <motion.div
          layout="size"
