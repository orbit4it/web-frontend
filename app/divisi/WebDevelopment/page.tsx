  ...
  return (
    <>
      <header className="w-max lg:flex items-center mx-auto pt-0 lg:mx-0 lg:gap-2 lg:static">
        <div className="w-24 h-24 rounded-full relative flex items-center mx-auto -top-[40px] lg:static glassmorphism-webdev before:rounded-full">
        <Image 
            src={Logo}
            alt='Logo'
      ...
      <section className="w-full h-[80vh] lg:h-[90vh] rounded-2xl mt-10 lg:mt-20 p-5 lg:p-10 bg-[#0e582c] flex flex-col gap-6 items-start overflow-hidden  relative">
        <motion.div
          layout="size"
