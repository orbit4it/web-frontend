  ...
  return (
    <>
        ...
        <div>
          <div className="h-max overflow-hidden">
            <motion.h1
              ...
              className="text-3xl font-bold opacity-30 text-white relative top-0 bottom-0 text-center lg:static"
            >
              WEB DEVELOPMENT
            </motion.h1>
          </div>
          <motion.div
            ...
            initial="hidden"
            animate="show"
            className="flex gap-1 text-base text-center text-white opacity-50"
          >
      ...
      <section className="w-full mt-14 lg:flex gap-16 px-5">
        ...
        Web Development adalah divisi yang dapat mengembangkan, membuat, dan memelihara sebuah website. Hal ini melibatkan perancangan tampilan, pengembangan kode, dan pengelolaan basis data.
        </p>
      ...
      <section className="w-full h-[80vh] lg:h-[90vh] rounded-2xl mt-28 p-10 bg-[#187a40]  flex flex-col gap-6 items-start overflow-hidden  relative">
        <motion.div
          layout="size"
